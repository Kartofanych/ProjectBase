...
include(":features:login:start:api")
include(":features:login:start:impl")
include(":features:login:process:api")
include(":features:login:process:impl")
...
include(":features:promo:api")
include(":features:promo:impl")
include(":features:promo:item:api")
