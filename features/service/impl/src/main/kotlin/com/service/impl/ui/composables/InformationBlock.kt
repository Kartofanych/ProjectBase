...
fun InformationBlock(
    ...
    val block = (uiState.state as? ServiceUiState.DataState.Content)?.service?.infoBlock ?: return
    Column(
        modifier = Modifier
        ...
        Row(
            modifier = Modifier
                ...
                .fillMaxWidth()
                .touchAction {
                    onAction(ServiceAction.ChangeScheduleVisibility)
                },
        ...
        Row(
            modifier = Modifier
                ...
                .fillMaxWidth()
                .touchAction {
                    onAction(ServiceAction.OpenOnMap)
                },
            horizontalArrangement = Arrangement.SpaceBetween,
            verticalAlignment = Alignment.CenterVertically
        ) {
